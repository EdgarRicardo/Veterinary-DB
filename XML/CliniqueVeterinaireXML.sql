...
INSERT INTO Animal VALUES (1,3,'Chat','Milos',TO_DATE('15/11/2016','DD/MM/YYYY'),XMLTYPE('<traitements>
	<traitement>
		<veterinaire>
			<nom>Segovia</nom>
			<prenom>Jesus</prenom>
...
INSERT INTO Animal VALUES (2,1,'Chien','Funky',TO_DATE('24/02/2017','DD/MM/YYYY'),XMLTYPE('<traitements>
	<traitement>
		<veterinaire>
			<nom>Murillo</nom>
			<prenom>Kevin</prenom>
...
INSERT INTO Animal VALUES (5,5,'Chien','MDoggo',TO_DATE('12/09/2006','DD/MM/YYYY'),XMLTYPE('<traitements>
	<traitement>
		<veterinaire>
			<nom>Murillo</nom>
			<prenom>Kevin</prenom>
...
--Requete 
SELECT  A.nom,A.traitements.EXTRACT('/traitements/traitement').GETSTRINGVAL() AS traitements
FROM Animal A;
